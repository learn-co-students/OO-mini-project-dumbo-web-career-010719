...
recipe_card_1 = RecipeCard.new(user_1, recipe_1, "10-1-2019", 5)
recipe_card_2 = RecipeCard.new(user_2, recipe_2, "10-30-2019", 10)
recipe_card_3 = RecipeCard.new(user_2, recipe_3, "11-15-2019", 7)
recipe_card_4 = RecipeCard.new(user_2, recipe_4, "12-24-2019", 4)
recipe_card_5 = RecipeCard.new(user_2, recipe_5, "9-24-2019", 2)
recipe_card_5 = RecipeCard.new(user_1, recipe_5, "9-24-2019", 2)
recipe_card_6 = RecipeCard.new(user_2, recipe_6, "7-16-2019", 9)
...
allergen_1 = Allergen.new("Swollen Lips", user_2, ingredient_3)
allergen_2 = Allergen.new("Hives", user_1, ingredient_3)
allergen_3 = Allergen.new("Puffy Cheeks", user_2, ingredient_3)
allergen_4 = Allergen.new("Heartburn", user_1, ingredient_2)
